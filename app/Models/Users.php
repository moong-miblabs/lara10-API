...
class Users
{
    static $table       = 'users';
    static $allias      = 'uu';
    static $columns     = ['id','username','password','nama','created_at','updated_at','deleted_at'];
    static $readable    = ['id','username','password','nama'];
    static $fillable    = ['username','password','nama'];
    static $order       = ['nama','ASC'];
