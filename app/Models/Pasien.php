...
class Pasien
{
    static $table       = 'pasien';
    static $allias      = 'pp';
    static $columns     = ['id','pin','nama_pasien','agama_id','device_id','tanggal_lahir','jenis_kelamin','first_assesmen','created_at','updated_at','deleted_at'];
    static $readable    = ['id','pin','nama_pasien','agama_id','device_id','tanggal_lahir','jenis_kelamin','first_assesmen'];
    static $fillable    = ['pin','nama_pasien','agama_id','device_id','tanggal_lahir','jenis_kelamin','first_assesmen'];
    static $order       = ['pin','nama_pasien','ASC'];
